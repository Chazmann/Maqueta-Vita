$(document).ready(function () {
  $("#searchEsp").on("click", function () {
    ...
    for (let i = 0; i < 4; i++) {
      // Seleccionar un médico aleatorio
                    ...
                    <div class="card">
                        <div class="card-body row">
                            <div class="col-9">
                                ...
                                <p class="card-text"><strong>Días:</strong> ${selectedDays.join(
                                  ", "
                                )}</p>
                                <p class="card-text"><strong>Horario:</strong> ${startHour}:00 - ${endHour}:00</p>
                            </div>
                            <div class="col-3">
